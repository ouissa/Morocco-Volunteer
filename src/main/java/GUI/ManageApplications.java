...
public class ManageApplications extends javax.swing.JFrame {
    ...
    public ManageApplications() {
        ...
        try (Connection conn = DriverManager.getConnection(url, uid, pw);
            Statement stmt = conn.createStatement()){
                ...
                String qry = "SELECT V.volunteerId, V.firstname, V.lastname, P.role, E.name"
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String qry = "UPDATE Application SET applicationStatus = 'rejected'"
                + " WHERE volunteerId = "+volunteerId+"";
        try (Connection conn = DriverManager.getConnection(url, uid, pw); ) {
            PreparedStatement prepStmt = conn.prepareStatement(qry);
            prepStmt.execute();
            JOptionPane.showMessageDialog(this, "Volunteer was Rejected");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int row = jTable1.getSelectedRow();
        int volunteerId = Integer.parseInt(jTable1.getModel().getValueAt(row, column).toString());
        String qry = "UPDATE Application SET applicationStatus = 'accepted'"
                + " WHERE volunteerId = "+volunteerId+"";
        try (Connection conn = DriverManager.getConnection(url, uid, pw); ) {
            PreparedStatement prepStmt = conn.prepareStatement(qry);
            prepStmt.execute();
            JOptionPane.showMessageDialog(this, "Volunteer was Accepted");
            ManageApplications frm = new ManageApplications();
            frm.setLocation(getLocation());
            frm.setSize(getSize());
            setVisible(false);
